...
const ModalRegisterRestaurant = props => {
    ...
    return (
        <div className="modal fade" id="modal_register_restaurant" tabIndex="-1" role="dialog"
                ...
                <div className="modal-content">
                    ...
                    <div className="form-group modal-body">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="phone" className="form-control" onChange={e => actions.handleChange(e)}></input>
                        </div>
                        <div className="form-group">
                    ...
                    <div className="modal-footer d-flex justify-content-end">
                        <button type="button" className="btn btn-primary mr-1" data-dismiss="modal" onClick={() => actions.registerRestaurantPost()}>Register</button>
