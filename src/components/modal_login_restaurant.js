...
const ModalLoginRestaurant = props => {
    ...
    const Confirmation = () => {
        BackToLogin()
        actions.getConfirmationRestaurant()
        alert("Check your email")
    }
    return (

        <div className="modal fade" id="modal_login_restaurant" tabIndex="-1" role="dialog"
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="form-group modal-body">
                        ...
                        <button type="button" className="btn btn-primary mr-1" data-dismiss="modal"  onClick={() =>actions.loginRestaurantPost()}>Access</button>
